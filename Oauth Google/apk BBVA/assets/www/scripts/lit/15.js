  ...
  992: function (t, r, e) {
    ...
    function o() {
      ...
      function L(t, r) {
        var e = r.method,
            n = t.iterator[e];
        if (void 0 === n) return r.delegate = null, "throw" === e && t.iterator.return && (r.method = "return", r.arg = void 0, L(t, r), "throw" === r.method) || "return" !== e && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + e + "' method")), p;
    ...
    e.r(r), e.d(r, "BbvaCardOfferOptionsEsApiDm", function () {
      return h;
    });
    ...
    var h = function (t) {
      ...
      return r = p, e = [{
        ...
        key: "is",
        get: function () {
          return "bbva-card-offer-options-es-api-dm";
        }
